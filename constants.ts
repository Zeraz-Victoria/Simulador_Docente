...
export const MOCK_DATA: Question[] = [
  ...
  },
  {
    ...
    "dominio": "Dominio 3: Una maestra, un maestro que genera ambientes favorables",
    "tema": "Evaluación Formativa",
    "pregunta": "Al concluir el primer trimestre, el director solicita a los docentes las calificaciones finales. Un profesor de cuarto grado le entrega una bitácora de observación, rúbricas de autoevaluación y evidencias de proyectos comunitarios, argumentando que aún no promedia un número. El director exige un número exacto fundamentado en exámenes estandarizados. Con base en los principios de la Nueva Escuela Mexicana, ¿qué enfoque de evaluación está defendiendo el docente?",
    "opciones": [
      { "id": "A", "texto": "Un enfoque de rendición de cuentas, priorizando la entrega oportuna de promedios para el sistema administrativo.", "es_correcta": false },
      { "id": "B", "texto": "Un enfoque formativo, continuo y cualitativo que valora el proceso de aprendizaje y no solo el resultado final o la asignación de un número.", "es_correcta": true },
      { "id": "C", "texto": "Un enfoque sumativo, donde las rúbricas y proyectos sirven únicamente para justificar la calificación aprobatoria.", "es_correcta": false },
      { "id": "D", "texto": "Un enfoque punitivo, evitando asentar calificaciones bajas para no afectar las estadísticas de reprobación de la escuela.", "es_correcta": false }
    ],
    "retroalimentacion": "La opción B es correcta. La NEM transita de una evaluación puramente sumativa y administrativa (enfocada en el número y el examen) hacia una evaluación formativa que valora el proceso, el diálogo y la retroalimentación cualitativa.",
    "fundamento_legal": "Plan de Estudios 2022. La evaluación de los aprendizajes con enfoque formativo."
  },
  {
    "nivel": "Secundaria",
    "dominio": "Dominio 2: Una maestra, un maestro que conoce a sus alumnos",
    "tema": "Inclusión y Equidad",
    "pregunta": "En un grupo de segundo grado, ingresa a mitad de ciclo una alumna con discapacidad motriz severa. El docente argumenta en CTE que 'no tiene la preparación especial ni el currículo adaptado para atenderla', sugiriendo que asista a un CAM (Centro de Atención Múltiple) para no atrasar al grupo. ¿Qué principio normativo se está vulnerando con esta postura?",
    "opciones": [
      { "id": "A", "texto": "El principio de eficiencia administrativa, ya que su inclusión desestabiliza la planeación escolar previamente entregada.", "es_correcta": false },
      { "id": "B", "texto": "El principio de normalidad mínima, pues los ritmos de aprendizaje deben ser homogéneos para garantizar el avance del programa.", "es_correcta": false },
      { "id": "C", "texto": "El principio de educación inclusiva, equitativa y libre de discriminación, el cual obliga a la escuela regular a realizar ajustes razonables y eliminar Barreras para el Aprendizaje y la Participación.", "es_correcta": true },
      { "id": "D", "texto": "El principio de corresponsabilidad, dado que es obligación exclusiva de la familia proveer a la alumna de un maestro sombra.", "es_correcta": false }
    ],
    "retroalimentacion": "La opción C es correcta. La Ley General de Educación prohíbe excluir a estudiantes por motivos de discapacidad. La actitud del docente refleja una visión segregacionista (enfoque anterior), mientras que la NEM exige eliminar las BAP (actitudinales en este caso).",
    "fundamento_legal": "Ley General de Educación, Art. 61 (Educación Inclusiva)."
  },
  {
    "nivel": "Preescolar",
    "dominio": "Dominio 1: Un maestro que asume su quehacer con apego a principios...",
    "tema": "Interculturalidad Crítica",
    "pregunta": "Para la conmemoración del 'Día de la Raza', una educadora planea organizar un desfile donde los niños se disfracen e invita a los padres a preparar platillos típicos, argumentando que así fomenta la interculturalidad. Sin embargo, no incluye actividades de reflexión sobre los saberes u origen de las comunidades indígenas presentes en su propia aula. Desde la NEM, ¿es adecuada esta práctica?",
    "opciones": [
      { "id": "A", "texto": "Sí, porque el folclorismo y los eventos cívicos cumplen con los requerimientos administrativos del calendario escolar y mantienen buenas relaciones con la comunidad.", "es_correcta": false },
      { "id": "B", "texto": "No, porque la interculturalidad crítica supera el folclor y la 'celebración de la diversidad'; busca el diálogo horizontal, el combate al racismo y la revalorización profunda de los saberes locales e indígenas.", "es_correcta": true },
      { "id": "C", "texto": "Sí, siempre y cuando se solicite permiso a la supervisión para alterar el horario de clases y realizar el desfile.", "es_correcta": false },
      { "id": "D", "texto": "No, porque las festividades interrumpen el avance del programa analítico y reducen el tiempo efectivo de aprendizaje en el aula.", "es_correcta": false }
    ],
    "retroalimentacion": "La opción B es correcta. El enfoque anterior reducía la diversidad al folclor (interculturalidad funcional). La interculturalidad crítica en la NEM exige problematizar desigualdades, reconocer saberes y lograr un diálogo simétrico.",
    "fundamento_legal": "Plan de Estudios 2022. Ejes Articuladores: Interculturalidad Crítica."
  },
  {
    "nivel": "Telesecundaria",
    "dominio": "Dominio 1: Marco Normativo",
    "tema": "Autonomía Profesional",
    "pregunta": "Al inicio del ciclo escolar, la supervisora de zona les entrega a todos los directores una 'planeación didáctica general' que los docentes deben seguir estrictamente día a día, señalando que esto garantizará la excelencia educativa y facilitará la revisión burocrática. ¿Cómo deben responder los colectivos docentes ante esta indicación basados en el Plan 2022?",
    "opciones": [
      { "id": "A", "texto": "Agradecer la reducción de la carga administrativa, ya que estandarizar la enseñanza asegura el control de aprendizajes esperado por las autoridades.", "es_correcta": false },
      { "id": "B", "texto": "Reivindicar su autonomía profesional y la necesidad del codiseño, argumentando que la planeación debe surgir del diagnóstico socioeducativo y contextualizarse a su aula.", "es_correcta": true },
      { "id": "C", "texto": "Aceptar la planeación temporalmente mientras elaboran en secreto una distinta, para evitar actas administrativas de la supervisión.", "es_correcta": false },
      { "id": "D", "texto": "Solicitar que la planeación la apruebe la Asociación de Padres de Familia para darle legalidad al documento estandarizado.", "es_correcta": false }
    ],
    "retroalimentacion": "La opción B es correcta. El enfoque administrativo anterior prescribía currículos cerrados. La NEM reconoce al maestro como agente transformador con autonomía profesional para adaptar (codiseñar) el currículo a su realidad.",
    "fundamento_legal": "Plan de Estudios 2022. Autonomía Profesional y El Codiseño."
  },
  {
    "nivel": "Generales",
    "dominio": "Dominio 3: Práctica educativa",
    "tema": "Plan de Estudios 2022 (Metodologías)",
    "pregunta": "Durante una sesión de Consejo Técnico Escolar, los maestros debaten sobre cómo trabajar la lectura y escritura. Un grupo sostiene que deben dedicar la primera mitad del ciclo a memorizar reglas gramaticales y planas del libro de texto. Otro grupo propone diseñar un Proyecto Comunitario donde los alumnos investiguen un problema local y escriban cartas a las autoridades. ¿Qué postura es acorde a los principios de la Nueva Escuela Mexicana?",
    "opciones": [
      { "id": "A", "texto": "La primera, porque el aprendizaje de reglas asegura que aprueben los exámenes estandarizados y facilita el llenado de boletas.", "es_correcta": false },
      { "id": "B", "texto": "Ambas posturas son erróneas; el director debe asignar a cada maestro los contenidos aislados que les toca cubrir cada mes.", "es_correcta": false },
      { "id": "C", "texto": "La segunda, porque vincula los saberes escolares con la realidad comunitaria, dando sentido a la escritura (prácticas sociales del lenguaje) mediante metodologías sociocríticas.", "es_correcta": true },
      { "id": "D", "texto": "La primera, ya que el rigor disciplinar aislado es la única forma comprobada de alcanzar la excelencia académica requerida por el Artículo 3°.", "es_correcta": false }
    ],
    "retroalimentacion": "La opción C es correcta. La NEM promueve el aprendizaje situado y metodologías sociocríticas (como ABP) que trascienden la fragmentación del conocimiento y la mera memorización administrativa.",
    "fundamento_legal": "Plan de Estudios 2022. Campos Formativos y Metodologías Activas."
  }
];